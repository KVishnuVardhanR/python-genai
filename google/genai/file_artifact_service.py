...
class FileArtifactService:
  ...
  def _save_artifact_sync(
    ...
    if isinstance(artifact, types.Part) and artifact.inline_data:
      data = artifact.inline_data.data
      mime_type = artifact.inline_data.mime_type
    elif isinstance(artifact, types.Blob):
      data = artifact.data
    ...
    logger.debug(
        "Saved artifact %s version %d to %s", filename, next_version, version_dir
    )
    return next_version
